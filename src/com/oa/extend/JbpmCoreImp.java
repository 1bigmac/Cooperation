...
public class JbpmCoreImp implements JbpmCore {
	...
	/* (non-Javadoc)
	 * @see com.oa.extend.JbpmCore#addProcessInstance(java.lang.String, com.oa.model.Document)
	 */
...
//		}
	...
	/* (non-Javadoc)
	 * @see com.oa.extend.JbpmCore#nextStep(long, java.lang.String, java.lang.String)
	 */
...
/*	public List searchMyTaskList(String actorId) {
		...
		for (Iterator iterator = taskInstances.iterator(); iterator.hasNext();) {
			TaskInstance ti = (TaskInstance) iterator.next();
			Object docId = ti.getProcessInstance().getContextInstance().getVariable("document");
			docIds.add(docId);
		}
		...
		System.out.println(docId+" jbpmCoreIMp searchMyTaskList findPooledTaskInstances");
			docIds.add(docId);
		}
		context.close();
		return docIds;
	...
	/* (non-Javadoc)
	 * @see com.oa.extend.JbpmCore#setJbpmTemplate(org.springmodules.workflow.jbpm31.JbpmTemplate)
	 */
	@Resource
